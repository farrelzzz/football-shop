...
SECRET_KEY = 'django-insecure-wyr971hsv5b7mz%_(6t1whe*jv67b=-^v+ce$8zu2#kz%-+-qj'
...
##
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "muhammad-farrel46-footballshop.pbp.cs.ui.ac.id", "10.0.2.2"]
